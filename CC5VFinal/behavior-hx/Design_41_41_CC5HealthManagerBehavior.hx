...
class Design_41_41_CC5HealthManagerBehavior extends ActorScript
{          	
...
_HealthBarOrientation = "Horizontal";
nameMap.set("Health Bar Outline Colour", "_HealthBarOutlineColour");
_HealthBarOutlineColour = Utils.getColorRGB(128,128,128);
...
/* ======================== When Creating ========================= */
        _StartingHealth = asNumber(Engine.engine.getGameAttribute("CC5LifePoints"));
propertyChanged("_StartingHealth", _StartingHealth);
        _MaximumHealth = asNumber(Engine.engine.getGameAttribute("CC5LifePoints"));
propertyChanged("_MaximumHealth", _MaximumHealth);
            ...
            else
{
            ...
            g.drawString("" + "Life:", 20, (_HealthBarYOffset - 40));
}
        ...
        if(Engine.engine.getGameAttribute("GameIsOn"))
{
            ...
            Engine.engine.setGameAttribute("CC5LifePoints", (Engine.engine.getGameAttribute("CC5LifePoints") - 1));
            _CurrentHealth = asNumber(Engine.engine.getGameAttribute("CC5LifePoints"));
propertyChanged("_CurrentHealth", _CurrentHealth);
